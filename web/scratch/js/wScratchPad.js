      ...
      this.post(scratchConf.compApi, "{\"lotId\":\""+_lotId+"\"}",
          function(data) {
            ...
            if(data.errorCode === '0000') {
              ...
              window.localStorage.removeItem(scratchConf.applicationId + "-user_point_" + scratchConf.accessToken);
